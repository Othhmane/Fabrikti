      ...
      <Card className="w-full max-w-md p-8 border-none shadow-2xl shadow-blue-100">
        <div className="text-center mb-8">
          <div className="relative inline-block mb-6">
            ...
            <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-white rounded-full border-2 border-slate-50 flex items-center justify-center text-slate-300 shadow-sm overflow-hidden">
               <UserIcon size={16} />
            </div>
          </div>
